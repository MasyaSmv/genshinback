...
class CreateCharacterSkillAtksTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('character_skill_atks', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('character_skill_atks');
    }
}
